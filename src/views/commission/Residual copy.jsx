...
export default function Residual() {
  ...
  const [tmrSpan, setTmrSpan] = useState(true);
      ...
      .then((res) => {
        ...
        const newData = res?.data?.data?.map((curr) => ({
          ...
          monthly_residual: curr[
            "ptsave_totalmonthlyresidualrollup@OData.Community.Display.V1.FormattedValue"
          ]
            ? curr[
                "ptsave_totalmonthlyresidualrollup@OData.Community.Display.V1.FormattedValue"
              ]
        ...
        <div className="row mb-3">
          ...
          <div className="col-md-8">
            {year === "" || year === "2023" || year === 2023 ? (
              ...
              <Chart
                options={apexResidual1?.options}
                series={apexResidual1?.series}
                type="bar"
                // width="450"
              />
            ) : (
              ...
              <Chart
                options={apexResidual2?.options}
                series={apexResidual2?.series}
                type="bar"
                // width="450"
              />
            )}
        ...
        <div className="row">
          <div className="col-lg col-6 d-grid p-0">
            <button
              ...
              style={{ backgroundColor: `${year === "2023" ? "blue" : ""}` }}
            >
              2023
            </button>
          </div>
          <div className="col-lg col-6 d-grid p-0">
            <button
              ...
              style={{ backgroundColor: `${year === "2022" ? "blue" : ""}` }}
            >
              2022
            </button>
          </div>
          <div className="col-lg col-6 d-grid p-0">
            <button
              className="mb-2 basic_btn"
              style={{ backgroundColor: `${year === "2021" ? "blue" : ""}` }}
          ...
          <div className="col-lg col-6 d-grid p-0">
            <button
              className="mb-2 basic_btn"
              style={{ backgroundColor: `${year === "2020" ? "blue" : ""}` }}
          ...
          <div className="col-lg col-6 d-grid p-0">
            <button
              className="mb-2 basic_btn"
              style={{ backgroundColor: `${year === "2019" ? "blue" : ""}` }}
          ...
          <div className="col-lg col-6 d-grid p-0">
            <button
              className="mb-2 basic_btn"
              style={{ backgroundColor: `${year === "2018" ? "blue" : ""}` }}
          ...
          <div className="col-lg col-6 d-grid p-0">
            <button
              className="mb-2 basic_btn"
              style={{ backgroundColor: `${year === "2017" ? "blue" : ""}` }}
          ...
          <div className="col-lg col-6 d-grid p-0">
            <button
              className="mb-2 basic_btn"
              style={{ backgroundColor: `${year === "2016" ? "blue" : ""}` }}
