...
const RettriveCardTerminal = ({ type_name, id, lead_product, card }) => {
  RettriveCardTerminal.propTypes = {
  ...
  const handleAddMore = () => {
    dispatch({
      type: SET_CARD_TERMINAL_PRODUCT,
      REMOVE_CARD_TERMINAL_PRODUCT,
      payload: false,
    });
    setterminal(true);
  ...
  const handleChangeInput = (name, value, index) => {
    ...
    if (name === "ptsave_oldcardprovider") {
      dispatch(GetLeadsnput("ptsave_oldcardprovider", value));
    }
    ...
    if (name === "terminal_provider" && parseInt(value) === 0) {
      dispatch(
        GetTerminalProductInput("product_term", 12, index, "terminal_products")
      );
      dispatch(
    ...
    } else if (name === "terminal_provider" && parseInt(value) === 1) {
      dispatch(
  ...
  useEffect(() => {
    if (leadInput?.terminal_products && selectedContactLength !== "") {
      for (let index = 0; index < leadInput.terminal_products.length; index++) {
        if (
          parseInt(leadInput.terminal_products[index].terminal_provider) === 1
        ) {
          dispatch(
            GetTerminalProductInput(
              "product_term",
  ...
  const getelavonProductList = (url) => {
    console.log("url", url);
    fetch(url, {
      method: "GET",
      headers: {
  ...
  useEffect(() => {
    for (
      let index = 0;
      index < leadInput?.terminal_products.length;
      index++
    ) {
      const previousAcquirer =
        leadInput.terminal_products[index].previous_acquirer;
  ...
  }, [leadInput?.terminal_products?.length]);
  return (
                      ...
                      <div className="card">
                        ...
                        <div className="p-3 mt-4">
                          ...
                          <div className="row mt-3">
                            ...
                            {parseInt(product.terminal_provider) === 1 ? (
                              <div className="col-md-12">
                                <div className="form-group">
                                  <label htmlFor="exampleSelect">
                                    <strong>
                              ...
                              parseInt(product.terminal_provider) === 0 && (
                                <div className="col-md-12">
                                  <div className="form-group">
                                    <label htmlFor="exampleSelect">
                                      <strong>
...
export default RettriveCardTerminal;
