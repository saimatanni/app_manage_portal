...
import { REMOVE_EPOS_PRODUCT, SET_EPOS_PRODUCT } from "../_redux/types/Types";
import { GetEposProductInput,  } from "../_redux/action/LeadAction";
import PropTypes from "prop-types";
import { useNavigate } from "react-router-dom";
import { IoIosAdd } from "react-icons/io";
import Cookies from 'js-cookie'; // Import js-cookie
const RetriveEpos = ({ type_name, id, lead_product }) => {
  ...
  const handleChangeInput = (name, value, index) => {
    ...
    dispatch(GetEposProductInput("lead_id", id, index, "epos_products"));
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            {leadInput?.epos_products?.length < 1 && (
              <button className="basic_btn" onClick={() => handleAddMore()}><IoIosAdd  style={{ fontSize: " 25px" }}/>
                ADD PRODUCT
              </button>
            )}
          </div>
                        ...
                        <div className="row">
                              ...
                              <div className="row">
                                <div className="col-md-12">
                                  <label
                                    ...
                                    className=""
                                  >
                                    <strong>Service Option<span style={{ color: "#dd2c00" }}> *</span> </strong>
                                  </label>
                                </div>
                          ...
                          <div className="col-md-12">
                            <div className="row mb-3">
                              <div className="col-md-12">
                                <strong>Integration Availability <span style={{ color: "#dd2c00" }}> *</span></strong>
                              </div>
                              <div className="col-md-12 mt-3">
                                <button
                                  className={`mb-2 ${
                              ...
                              <div className="form-group">
                                <div>
                                  <label htmlFor="basic-url">
                                    <strong>Integrated With<span style={{ color: "#dd2c00" }}>*</span></strong>
                                  </label>
                                  <div className=" my-3">
                                    <input
                                      type="text"
                          ...
                          <div className="col-md-12">
                            <div className="form-group">
                              <label htmlFor="exampleSelect">
                                <strong>Epos Provider <span style={{ color: "#dd2c00" }}>*</span></strong>
                              </label>
                              <input
                                type="text"
                                className="form-control my-3"
