...
import { perentalEntity } from "src/views/common/Dropdown";
export default function RetrieveCostAnalysis() {
  ...
  const handleChangeInput = (name, value, e) => {
    ...
    // let visa_devit_cost = (parseFloat(leadInput.visa_debit_cr) * leadInput.visa_debit_ts) / 100
  };
  let visa_devit_cost =
  ...
  console.log(
    ...
    perentalEntity(leadInput.parent_entity_code, "all_non_eea_visa_fee_pr")
  );
  return (
                ...
                <tbody>
                    ...
                    <td>
                      ...
                      >
                        <input
                          ...
                          // onBlur={(e) => setFocused(false)}
                          // value={
                          //   parseFloat(leadInput.visa_debit_pr) === 0
                          //     ? ""
                          //     : leadInput.visa_debit_pr
                          // }
                  ...
                  <tr>
                    ...
                    <input
                      ...
                      type="number"
                      placeholder="£"
                      name="mastercard_business_tr_no"
                      disabled
                      // value={parseInt(leadInput.mastercard_business_tr_no)}
                      onWheel={(e) => e.target.blur()}
                      onChange={(e) =>
                        handleChangeInput(
                          "mastercard_business_tr_no",
                          e.target.value
                        )
                      }
                    />
                  ...
                  <tr>
                    ...
                    <input
                      ...
                      type="number"
                      placeholder="£"
                      name="mastercard_corporate_tr_no"
                      disabled
                      // value={parseInt(leadInput.mastercard_corporate_tr_no)}
                      onWheel={(e) => e.target.blur()}
                      onChange={(e) =>
                        handleChangeInput(
                          "mastercard_corporate_tr_no",
                          e.target.value
                        )
                      }
                    />
                    ...
                    <td style={{ background: "#198754" }}>
                      ...
                      >
                        <input
                          ...
                          disabled
                          // value={leadInput.mastercard_corporate_pc}
                          onWheel={(e) => e.target.blur()}
                          onChange={(e) =>
                            handleChangeInput(
                              "mastercard_corporate_pc",
                  ...
                  <tr>
                    ...
                    <input
                      ...
                      type="number"
                      placeholder="£"
                      name="all_non_eea_visa_fee_tr_no"
                      disabled
                      // value={parseInt(leadInput.all_non_eea_visa_fee_tr_no)}
                      onWheel={(e) => e.target.blur()}
                      onChange={(e) =>
                        handleChangeInput(
                          "all_non_eea_visa_fee_tr_no",
                          e.target.value
                        )
                      }
                    />
              ...
              >
                {({ toPdf }) => (
                  <CButton
                    className="my-3"
                    onClick={() => {
                      handleGenerateQuote(leadInput, toPdf);
