...
const AppEposProduct = ({ type_name, id, quote_product }) => {
  const navigate = useNavigate();
  AppEposProduct.propTypes = {
  ...
  //     GetPricequoteInput(
  //       "epos_products",
  //       quote_product?.filter((item) => item?.product_type === "epos")
  //     )
  //   );
  // }, []);
  return (
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            {priceQuoteInput?.epos_products?.length < 1 && (
              <button className="my-4 basic_btn" onClick={() => handleAddMore()}>
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handleChangeInput("monthly_price", e.target.value, i)
                                }
                              />
                            </div>
                          </div>
