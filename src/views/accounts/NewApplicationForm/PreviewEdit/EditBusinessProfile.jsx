...
const EditBusinessProfile = ({toggleBusinessProfile}) => {
  ...
  return (
    <div className="customar-detail">
        ...
        <div className="head-first">
          ...
          <h4 style={{ color: "white" }}>Edit  Business Profile</h4>
        </div>
        <div className="button-box">
          <button className="  custom-btn  flex mx-2" onClick={toggleBusinessProfile}>
